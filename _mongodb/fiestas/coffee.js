...
db.fiesta.insertOne({
  ...
  title: 'Bringing Cordillera Coffee to Greater Heights',
  description: '',
  startDate: new Date('July 5, 2012'),
  endDate: new Date('July 6, 2012'),
  venue: 'BSU, La Trinidad, Benguet',
  region: 'CAR',
  commodity: [
    'Coffee'
  ],
  consortium: 'HARRDEC',
  consortiumFull: 'Highland Agriculture Resources Research and Development Consortium',
  vicinityMap: {path:'', credits:''},
  picture: {path:'assets/fiesta-logo.jpg', credits:''},
  coordinates: {lat:16.4519729, lng:120.5884668},
