...
db.fiesta.insertOne({
  ...
  title: 'Rambakan sa Lambak',
  description: '',
  startDate: new Date('February 23, 2012'),
  endDate: new Date('February 24, 2012'),
  venue: 'ISU, Echague, Isabela',
  region: 'Region II',
  commodity: [
    'Peanut', 'Goat', 'Banana'
  ],
  consortium: 'CVARRD',
  consortiumFull: 'Cagayan Valley Agriculture Resources Research and Development Consortium',
  vicinityMap: {path:'', credits:''},
  picture: {path:'assets/fiesta-logo.jpg', credits:''},
  coordinates: {lat:16.7221221, lng:121.6897147},
