...
db.fiesta.insertOne({
  ...
  title: 'Manggahan Festival',
  description: '',
  startDate: new Date('April 16, 2012'),
  endDate: new Date('April 20, 2012'),
  venue: 'Guimaras Capitol, San Miguel, Jordan, Guimaras',
  region: 'Region IV',
  commodity: [
    'Mango'
  ],
  consortium: 'WESVARRDEC',
  consortiumFull: 'Western Visayas Agriculture Resources Research and Development Consortium',
  vicinityMap: {path:'', credits:''},
  picture: {path:'assets/fiesta-logo.jpg', credits:''},
  coordinates: {lat:10.5834219, lng:122.5655194},
