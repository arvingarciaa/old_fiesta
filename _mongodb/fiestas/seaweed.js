...
db.fiesta.insertOne({
  ...
  title: 'Seaweed',
  description: '',
  startDate: new Date('November 27, 2014'),
  endDate: new Date('November 28, 2014'),
  venue: 'Passig Islet, Brgy. Bato, Sta. Cruz, Davao del Sur',
  region: 'Region XI',
  commodity: [
    'Seaweed'
  ],
  ...
  coordinates: {lat:6.8115675, lng:125.3775013},
