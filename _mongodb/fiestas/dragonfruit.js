...
db.fiesta.insertOne({
  ...
  title: 'Dragonfruit',
  description: '',
  startDate: new Date('July 5, 2011'),
  endDate: new Date('July 8, 2011'),
  venue: 'Burgos, Ilocos Norte',
  region: 'Region I',
  commodity: [
    'Dragonfruit'
  ],
  consortium: 'ILARRDEC',
  consortiumFull: 'Ilocos Agriculture and Resources Research and Development Consortium',
  vicinityMap: {path:'', credits:''},
  picture: {path:'assets/fiesta-logo.jpg', credits:''},
  coordinates: {lat:18.4633999, lng:120.5733148},
