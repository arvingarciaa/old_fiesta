...
db.fiesta.insertOne({
  ...
  title: 'STAARRDEC',
  description: '',
  startDate: new Date('November 21, 2016'),
  endDate: new Date('November 24, 2016'),
  venue: 'Bacoor Government Center, Bacoor City, Cavite',
  region: 'Region IV-A',
  commodity: [
    'Banana', 'Coffee'
  ],
  consortium: 'STAARRDEC',
  consortiumFull: 'Southern Tagalog Agriculture and Aquatic Resources Research, Development and Extension Consortium',
  vicinityMap: {path:'', credits:''},
  picture: {path:'assets/fiesta-logo.jpg', credits:''},
  coordinates: {lat:14.4320203, lng:120.9659207},
